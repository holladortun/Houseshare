    ...
    <>
      {preloader ? (
        <div className="flex items-center justify-center absolute top-0 h-[100vh] w-full bg-white  z-40 px-5">
          <PulseLoader size={10} color="#444ce7" speedMultiplier={0.8} />
        </div>
      ) : (
        <div className="flex items-center justify-center absolute top-0 h-[100vh] w-full bg-white  z-40 px-5">
                ...
                <div className="flex flex-col sm:flex-row  mt-4 gap-6 w-[100%]">
                  ...
                  >
                    ...
                    >
                      ...
                      <p className="text-[14px] text-left">
                        Put up your property to get a roommate that fits your
                        needs
                      </p>
                    </div>
                  </button>
                  ...
                  >
                    ...
                    >
                      ...
                      <p className="text-[14px] text-left">
                        Look for a short-let apartment that is within your
                        budget
                      </p>
                    </div>
                  </button>
