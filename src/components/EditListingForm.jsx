...
const EditListingForm = () => {
  ...
  const editedListing = useRecoilValue(editedListingState);
          ...
          >
            <div className="flex flex-col gap-2">
              ...
              <input
                type="text"
                maxLength="50"
                placeholder={editedListing?.title}
            ...
            <div className="flex flex-col xl:flex-row gap-8">
              <div className="flex flex-col gap-2 xl:w-[50%]">
                ...
                <input
                  type="number"
                  id="name"
                  placeholder={editedListing?.bathrooms}
                  className="border py-2 rounded-lg pl-4"
                  required
                  value={bathrooms}
              ...
              <div className="flex flex-col gap-2 xl:w-[50%]">
                ...
                <input
                  type="number"
                  id="name"
                  placeholder={editedListing?.bedrooms}
                  className="border py-2 rounded-lg pl-4"
                  required
                  value={bedrooms}
            ...
            <div className="flex flex-col xl:flex-row gap-8">
              <div className="flex flex-col gap-2 xl:w-[50%]">
                ...
                <input
                  type="text"
                  placeholder={editedListing?.location}
            ...
            <div className="flex gap-8 flex-col xl:flex-row">
              <div className="flex flex-col gap-2 xl:w-[50%]">
                ...
                <input
                  type="number"
                  placeholder={editedListing?.amount}
                  required
                  className="border py-2 rounded-lg pl-4"
                  value={amount}
